...
| experiment               |cmd                                                                                                 |
|--------------------------|----------------------------------------------------------------------------------------------------|
| outer_lr=5e-3            | `bsub -n 4 -J "maml-5e-3" -W 300:00 -R "rusage[mem=4096]" 'python src/maml_trpo_metaworld_ml1_basketball.py --outer_lr 5e-3'` |
| outer_lr=1e-3 default    | `bsub -n 4 -J "maml-1e-3" -W 300:00 -R "rusage[mem=4096]" 'python src/maml_trpo_metaworld_ml1_basketball.py --outer_lr 1e-3'` |
| outer_lr=5e-4            | `bsub -n 4 -J "maml-5e-4" -W 300:00 -R "rusage[mem=4096]" 'python src/maml_trpo_metaworld_ml1_basketball.py --outer_lr 5e-4'` |
...
| experiment               |cmd                                                                                                 |
|--------------------------|----------------------------------------------------------------------------------------------------|
| outer_lr=5e-3            | `bsub -n 20 -J "maml45-5e-3" -W 300:00 -R "rusage[mem=4096]" 'python src/maml_trpo_metaworld_ml45.py --outer_lr 5e-3'` |
| outer_lr=1e-3 default    | `bsub -n 20 -J "maml45-1e-3" -W 300:00 -R "rusage[mem=4096]" 'python src/maml_trpo_metaworld_ml45.py --outer_lr 1e-3'` |
| outer_lr=5e-4            | `bsub -n 20 -J "maml45-5e-4" -W 300:00 -R "rusage[mem=4096]" 'python src/maml_trpo_metaworld_ml45.py --outer_lr 5e-4'` |
